...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='varShu@1',db='resumeparser')
...
def run():
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Hang On While We Generate a perfect CV...'):
                time.sleep(4)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align='justify'>
            Our tool utilizes cutting-edge Natural Language Processing (NLP) technology to analyze resumes, extracting crucial keywords and organizing them into relevant industry sectors. Through this process, we offer personalized recommendations, predictive insights, and valuable analytics to empower job seekers in navigating their career paths effectively.
        </p>
        ...
        <p align="justify">
            ...
            It will parse your resume and provide you all necessary inputs.<br/><br/>
            <b>Feedback -</b> <br/>
           Users are asked to enter feeback for the improvement of the webpage, here users should enter their name, mail and give commennts.<br/><br/>
        </p><br/><br/>

        <p align="justify">
           Developed by 3rd year 2021 Data Science Students 
           <b>Nilavini B M  -</b>
           <b>Rajaneha R -</b>
           <b>Varsha S -</b>
        </p>
